...
const defaultFaqs = [
  ...
  { question: "Vocês atendem fora da cidade?", answer: "Sim! Somos de Blumenau (SC) e atendemos casamentos em toda Santa Catarina, com destaque para Florianópolis, Joinville, Balneário Camboriú e região do Vale do Itajaí. Também realizamos destination weddings em todo o Brasil e exterior. Deslocamentos fora da Grande Blumenau possuem custos adicionais de transporte e hospedagem, informados no orçamento." },
...
const FAQ = () => {
  const { getValue } = useSiteContent("faq");
  const faqs = getValue("faq", "items", defaultFaqs);
